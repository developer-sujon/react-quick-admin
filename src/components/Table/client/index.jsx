...
import { shunnoStorageBaseURL } from "../../../config";
    ...
    <>
      <Row>
        <Col sm={5}>
          ...
          {false && dataTable.selectedFlatRows?.length > 0 && (
            <Button
              variant="danger"
              onClick={() =>
      ...
      <div style={{ display: "none" }}>
        <PdfToPrint ref={printRef}>
          <div
            style={{ minHeight: 842, color: "black" }}
                  ...
                  <img
                    src={
                      activeStore?.storeLogo
                        ? shunnoStorageBaseURL + activeStore.storeLogo
                        : emptyImage
                    }
                    alt="Logo"
                    style={{
      ...
      {pagination && exportData?.values?.length > 0 && (
        <Pagination
